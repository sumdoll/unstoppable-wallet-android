...
class OrderViewFactory(
    ...
    fun getOverviewViewItem(item: OrderOverviewItem): OrderOverviewViewItem {
        val overview = item.marketInfoOverview

        return OrderOverviewViewItem(
    ...
    private fun getMarketItems(
        ...
        overview.marketCap?.let {
            ...
            items.add(
                CoinDataItem(Translator.getString(R.string.CoinPage_MarketCap),
                marketCapString,
        ...
        overview.volume24h?.let {
            ...
            items.add(
                CoinDataItem(Translator.getString(R.string.CoinPage_TradingVolume),
                volumeString)
            )
        }
        ...
        overview.dilutedMarketCap?.let {
            ...
            items.add(
                CoinDataItem(Translator.getString(R.string.CoinPage_DilutedMarketCap),
        ...
        overview.totalSupply?.let {
            val totalSupplyString = numberFormatter.formatCoinShort(it,
                ...
                8)
            items.add(
                CoinDataItem(Translator.getString(R.string.CoinPage_TotalSupply),
                totalSupplyString)
            )
        }
        ...
        overview.circulatingSupply?.let {
            val supplyString = numberFormatter.formatCoinShort(it,
                ...
                8)
            items.add(
                CoinDataItem(Translator.getString(R.string.CoinPage_inCirculation),
                supplyString)
            )
        }
        ...
        overview.genesisDate?.let {
            ...
            items.add(
                CoinDataItem(Translator.getString(R.string.CoinPage_LaunchDate),
                genesisDateString)
            )
        }
