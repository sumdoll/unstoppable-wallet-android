...
import io.horizontalsystems.bankwallet.arcticfish.modules.order.OrderFragment
...
fun onItemClick(marketViewItem: MarketViewItem, navController: NavController) {
    val arguments = OrderFragment.prepareParams(marketViewItem.coinUid)
    navController.slideFromRight(R.id.orderFragment, arguments)
}
